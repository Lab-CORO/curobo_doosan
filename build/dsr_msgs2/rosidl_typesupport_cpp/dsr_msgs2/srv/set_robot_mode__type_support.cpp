...
static const _SetRobotMode_Request_type_support_symbol_names_t _SetRobotMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, SetRobotMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, SetRobotMode_Request)),
  }
};
...
get_message_type_support_handle<dsr_msgs2::srv::SetRobotMode_Request>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::SetRobotMode_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, SetRobotMode_Request)() {
  return get_message_type_support_handle<dsr_msgs2::srv::SetRobotMode_Request>();
}
...
static const _SetRobotMode_Response_type_support_symbol_names_t _SetRobotMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, SetRobotMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, SetRobotMode_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dsr_msgs2::srv::SetRobotMode_Response>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::SetRobotMode_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, SetRobotMode_Response)() {
  return get_message_type_support_handle<dsr_msgs2::srv::SetRobotMode_Response>();
}
...
static const _SetRobotMode_type_support_symbol_names_t _SetRobotMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, SetRobotMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, SetRobotMode)),
  }
};
...
get_service_type_support_handle<dsr_msgs2::srv::SetRobotMode>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::SetRobotMode_service_type_support_handle;
}
