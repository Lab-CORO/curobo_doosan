...
static const _MoveJoint_Request_type_support_symbol_names_t _MoveJoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveJoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, MoveJoint_Request)),
  }
};
...
get_message_type_support_handle<dsr_msgs2::srv::MoveJoint_Request>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::MoveJoint_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, MoveJoint_Request)() {
  return get_message_type_support_handle<dsr_msgs2::srv::MoveJoint_Request>();
}
...
static const _MoveJoint_Response_type_support_symbol_names_t _MoveJoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveJoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, MoveJoint_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dsr_msgs2::srv::MoveJoint_Response>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::MoveJoint_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, MoveJoint_Response)() {
  return get_message_type_support_handle<dsr_msgs2::srv::MoveJoint_Response>();
}
...
static const _MoveJoint_type_support_symbol_names_t _MoveJoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveJoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, MoveJoint)),
  }
};
...
get_service_type_support_handle<dsr_msgs2::srv::MoveJoint>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::MoveJoint_service_type_support_handle;
}
