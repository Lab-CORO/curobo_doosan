...
static const _MoveLine_Request_type_support_symbol_names_t _MoveLine_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveLine_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, MoveLine_Request)),
  }
};
...
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::MoveLine_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, MoveLine_Request)() {
  return get_message_type_support_handle<dsr_msgs2::srv::MoveLine_Request>();
}
...
static const _MoveLine_Response_type_support_symbol_names_t _MoveLine_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveLine_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, MoveLine_Response)),
  }
};
...
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::MoveLine_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, MoveLine_Response)() {
  return get_message_type_support_handle<dsr_msgs2::srv::MoveLine_Response>();
}
...
static const _MoveLine_type_support_symbol_names_t _MoveLine_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveLine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, MoveLine)),
  }
};
...
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::MoveLine_service_type_support_handle;
}
