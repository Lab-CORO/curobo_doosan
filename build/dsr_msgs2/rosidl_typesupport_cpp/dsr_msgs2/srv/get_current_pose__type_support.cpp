...
static const _GetCurrentPose_Request_type_support_symbol_names_t _GetCurrentPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, GetCurrentPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, GetCurrentPose_Request)),
  }
};
...
get_message_type_support_handle<dsr_msgs2::srv::GetCurrentPose_Request>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::GetCurrentPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, GetCurrentPose_Request)() {
  return get_message_type_support_handle<dsr_msgs2::srv::GetCurrentPose_Request>();
}
...
static const _GetCurrentPose_Response_type_support_symbol_names_t _GetCurrentPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, GetCurrentPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, GetCurrentPose_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dsr_msgs2::srv::GetCurrentPose_Response>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::GetCurrentPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, GetCurrentPose_Response)() {
  return get_message_type_support_handle<dsr_msgs2::srv::GetCurrentPose_Response>();
}
...
static const _GetCurrentPose_type_support_symbol_names_t _GetCurrentPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, GetCurrentPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, GetCurrentPose)),
  }
};
...
get_service_type_support_handle<dsr_msgs2::srv::GetCurrentPose>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::GetCurrentPose_service_type_support_handle;
}
