...
static const _MoveJointx_Request_type_support_symbol_names_t _MoveJointx_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveJointx_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, MoveJointx_Request)),
  }
};
...
get_message_type_support_handle<dsr_msgs2::srv::MoveJointx_Request>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::MoveJointx_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, MoveJointx_Request)() {
  return get_message_type_support_handle<dsr_msgs2::srv::MoveJointx_Request>();
}
...
static const _MoveJointx_Response_type_support_symbol_names_t _MoveJointx_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveJointx_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, MoveJointx_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dsr_msgs2::srv::MoveJointx_Response>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::MoveJointx_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, MoveJointx_Response)() {
  return get_message_type_support_handle<dsr_msgs2::srv::MoveJointx_Response>();
}
...
static const _MoveJointx_type_support_symbol_names_t _MoveJointx_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, MoveJointx)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, MoveJointx)),
  }
};
...
get_service_type_support_handle<dsr_msgs2::srv::MoveJointx>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::MoveJointx_service_type_support_handle;
}
