...
static const _GetModbusInput_Request_type_support_symbol_names_t _GetModbusInput_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, GetModbusInput_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, GetModbusInput_Request)),
  }
};
...
get_message_type_support_handle<dsr_msgs2::srv::GetModbusInput_Request>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::GetModbusInput_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, GetModbusInput_Request)() {
  return get_message_type_support_handle<dsr_msgs2::srv::GetModbusInput_Request>();
}
...
static const _GetModbusInput_Response_type_support_symbol_names_t _GetModbusInput_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, GetModbusInput_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, GetModbusInput_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dsr_msgs2::srv::GetModbusInput_Response>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::GetModbusInput_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dsr_msgs2, srv, GetModbusInput_Response)() {
  return get_message_type_support_handle<dsr_msgs2::srv::GetModbusInput_Response>();
}
...
static const _GetModbusInput_type_support_symbol_names_t _GetModbusInput_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dsr_msgs2, srv, GetModbusInput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dsr_msgs2, srv, GetModbusInput)),
  }
};
...
get_service_type_support_handle<dsr_msgs2::srv::GetModbusInput>()
{
  return &::dsr_msgs2::srv::rosidl_typesupport_cpp::GetModbusInput_service_type_support_handle;
}
